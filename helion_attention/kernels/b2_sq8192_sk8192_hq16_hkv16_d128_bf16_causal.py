...
Autotuning provenance:
    ...
    Autotuning wall time: 1831.128 s
    Measured time: 5.195488 ms
...
def _helion_causal_attention_bshd(q, k, v, out, qk_scale, _RDIM_SIZE_3: tl.constexpr):
    ...
    out_desc = tl.make_tensor_descriptor(out, [2, 8192, 16, 128], [16777216, 2048, 128, 1], [1, _BLOCK_SIZE_2, 1, 128])
...
def attention(q: torch.Tensor, k: torch.Tensor, v: torch.Tensor, sm_scale: float, *, _launcher=_default_launcher):
    ...
    _launcher(_helion_causal_attention_bshd, (2 * 16,), q, k, v, out, qk_scale, _RDIM_SIZE_3, num_warps=8, num_stages=3)

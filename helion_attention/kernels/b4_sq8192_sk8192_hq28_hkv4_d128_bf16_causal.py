...
Autotuning provenance:
    ...
    Autotuning wall time: 1495.767 s
    Measured time: 5.274816 ms
...
def _helion_causal_attention_bshd(q, k, v, out, qk_scale, _RDIM_SIZE_3: tl.constexpr):
    ...
    q_desc = tl.make_tensor_descriptor(q, [4, 8192, 28, 128], [29360128, 3584, 128, 1], [1, _BLOCK_SIZE_2, 1, 128])
    ...
    for offset_2 in tl.range(0, 8192, _BLOCK_SIZE_2, flatten=True):

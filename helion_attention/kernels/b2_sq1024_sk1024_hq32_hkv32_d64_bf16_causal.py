...
def _helion_causal_attention_bshd(q, k, v, out, qk_scale, _NUM_SM: tl.constexpr, _RDIM_SIZE_3: tl.constexpr):
    ...
    q_desc = tl.make_tensor_descriptor(q, [2, 1024, 32, 64], [2097152, 2048, 64, 1], [1, _BLOCK_SIZE_2, 1, 64])
    ...
    v_desc = tl.make_tensor_descriptor(v, [2, 1024, 32, 64], [2097152, 2048, 64, 1], [1, _BLOCK_SIZE_4, 1, 64])
    ...
    for virtual_pid in tl.range(start_pid, end_pid):
        ...
        for offset_2 in tl.range(0, 1024, _BLOCK_SIZE_2, disallow_acc_multi_buffer=False, flatten=True):

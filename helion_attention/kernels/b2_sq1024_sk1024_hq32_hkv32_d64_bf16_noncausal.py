...
def _helion_attention_bshd(q, k, v, out, qk_scale, _RDIM_SIZE_3: tl.constexpr):
    ...
    for offset_2 in tl.range(0, 1024, _BLOCK_SIZE_2, disallow_acc_multi_buffer=True, flatten=False):
        ...
        for offset_4 in tl.range(0, 1024, _BLOCK_SIZE_4, disallow_acc_multi_buffer=False, flatten=False):
        ...
        out_desc.store([offset_0, offset_2, offset_1, 0 + 0], tl.cast(tl.reshape(v_12, [1, _BLOCK_SIZE_2, 1, _RDIM_SIZE_3]), tl.bfloat16))
...
def attention(q: torch.Tensor, k: torch.Tensor, v: torch.Tensor, sm_scale: float, *, _launcher=_default_launcher):
    ...
    _launcher(_helion_attention_bshd, (32 * 2,), q, k, v, out, qk_scale, _RDIM_SIZE_3, num_warps=16, num_stages=3)

...
Autotuning provenance:
    ...
    Autotuning wall time: 1385.067 s
    Measured time: 1.402624 ms
...
def _helion_causal_attention_bshd(q, k, v, out, qk_scale, _NUM_SM: tl.constexpr, _RDIM_SIZE_3: tl.constexpr):
    ...
    v_desc = tl.make_tensor_descriptor(v, [4, 4096, 4, 128], [2097152, 512, 128, 1], [1, _BLOCK_SIZE_4, 1, 128])
    # src[helion_kernels.py:270]: out[b, tile_m, h, :] = result.to(out.dtype)
    out_desc = tl.make_tensor_descriptor(out, [4, 4096, 28, 128], [14680064, 3584, 128, 1], [1, _BLOCK_SIZE_2, 1, 128])

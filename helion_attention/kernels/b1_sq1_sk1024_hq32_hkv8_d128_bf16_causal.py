...
def _helion_causal_attention_bshd(q, k, v, out, qk_scale, _RDIM_SIZE_3: tl.constexpr):
    ...
    for offset_2 in tl.static_range(0, 1):
        ...
        symnode_0 = 1024 * (1024 <= 1024 + offset_2) + (1024 + offset_2) * (1024 + offset_2 < 1024)
        for offset_4 in tl.range(0, tl.cast(symnode_0, tl.int32), _BLOCK_SIZE_4, disallow_acc_multi_buffer=False, flatten=False):
            ...
            v_blk = tl.load(v + (indices_4[:, None] * 1024 + symnode_1 * 128 + (0 + indices_3)[None, :] * 1), mask_4[:, None], other=0, eviction_policy='evict_last')

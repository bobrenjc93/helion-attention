...
| [`b1_sq1_sk16384_hq32_hkv8_d128_bf16_causal`](helion_attention/kernels/b1_sq1_sk16384_hq32_hkv8_d128_bf16_causal.py) | 1.4.0 | fixed | 0 s | 0.105506 ms | decode_attention_bshd_split_kv_partials: `helion.Config(block_sizes=[128], loop_orders=[[1, 2, 0]], num_stages=3, num_warps=4, pid_type='flat')`<br>decode_attention_bshd_split_kv_combine: `helion.Config(num_stages=3, num_warps=1, pid_type='flat')` | — |
...
| batch=1 seqlen_q=1 seqlen_k=16384 nheads=32 (GQA 32:8) head_dim=128 dtype=bf16 causal=True | 67 | 214 | 84 | 263 | 199 | 4 | **3.18x faster** |

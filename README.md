...
Against FlashAttention 3, Helion is faster on 15 kernel workloads and slower on 18 kernel workloads.

Geomean speedup over FlashAttention 3 across all 33 comparable kernel workloads: **1.16x**.

Helion is the fastest measured implementation on 13 of 35 workloads; FA2, FA3, or a PyTorch SDPA backend is faster on the remainder.
<!-- BENCHMARKS:END -->

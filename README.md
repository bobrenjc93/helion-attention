...
Every generated module records the exact Helion version and copyable
...
the rejected config and timing remain in the manifest and module docstring.
...
| [`b1_sq1_sk16384_hq32_hkv8_d128_bf16_causal`](helion_attention/kernels/b1_sq1_sk16384_hq32_hkv8_d128_bf16_causal.py) | 1.4.0 | fixed | 0 s | 0.116448 ms | decode_attention_bshd_split_kv_partials: `helion.Config(block_sizes=[128], loop_orders=[[1, 2, 0]], num_stages=3, num_warps=4, pid_type='flat')`<br>decode_attention_bshd_split_kv_combine: `helion.Config(num_stages=3, num_warps=1, pid_type='flat')` |
...
| [`b1_sq2048_sk2048_hq28_hkv4_d128_bf16_causal`](helion_attention/kernels/b1_sq2048_sk2048_hq28_hkv4_d128_bf16_causal.py) | 1.4.0 | autotuned | 10.1 min | 0.393040 ms | `helion.Config(atomic_indexing=[], block_sizes=[128, 128], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'pointer'], l2_groupings=[2], load_eviction_policies=['first', '', ''], loop_orders=[[1, 0]], num_sm_multiplier=1, num_stages=3, num_warps=8, pid_type='persistent_blocked', range_flattens=[False, False, False], range_multi_buffers=[True, False, True], range_num_stages=[1, 0, 0], range_unroll_factors=[1, 4, 2], range_warp_specializes=[])` |
| [`b1_sq2048_sk2048_hq32_hkv32_d128_bf16_causal`](helion_attention/kernels/b1_sq2048_sk2048_hq32_hkv32_d128_bf16_causal.py) | 1.4.0 | autotuned | 8.8 min | 0.417600 ms | `helion.Config(atomic_indexing=[], block_sizes=[128, 64], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'pointer'], l2_groupings=[64], load_eviction_policies=['first', 'first', ''], loop_orders=[[1, 0]], num_sm_multiplier=1, num_stages=5, num_warps=8, pid_type='persistent_interleaved', range_flattens=[None, None, True], range_multi_buffers=[None, False, True], range_num_stages=[0, 4, 1], range_unroll_factors=[0, 1, 4], range_warp_specializes=[])` |
| [`b1_sq2048_sk2048_hq32_hkv8_d128_bf16_causal`](helion_attention/kernels/b1_sq2048_sk2048_hq32_hkv8_d128_bf16_causal.py) | 1.4.0 | autotuned | 11.8 min | 0.384704 ms | `helion.Config(atomic_indexing=[], block_sizes=[128, 64], indexing=['tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[8], load_eviction_policies=['', '', 'first'], loop_orders=[[1, 0]], num_sm_multiplier=2, num_stages=3, num_warps=8, pid_type='persistent_blocked', range_flattens=[None, True, True], range_multi_buffers=[True, None, None], range_num_stages=[0, 4, 0], range_unroll_factors=[2, 3, 4], range_warp_specializes=[])` |
| [`b1_sq4096_sk4096_hq28_hkv4_d128_bf16_causal`](helion_attention/kernels/b1_sq4096_sk4096_hq28_hkv4_d128_bf16_causal.py) | 1.4.0 | autotuned | 22.2 min | 1.391712 ms | `helion.Config(atomic_indexing=[], block_sizes=[128, 64], indexing=['tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[64], load_eviction_policies=['first', 'last', 'last'], loop_orders=[[1, 0]], maxnreg=256, num_sm_multiplier=128, num_stages=3, num_warps=8, pid_type='persistent_interleaved', range_flattens=[True, True, None], range_multi_buffers=[False, None, False], range_num_stages=[1, 2, 3], range_unroll_factors=[3, 2, 3], range_warp_specializes=[])` |
...
| [`b1_sq8192_sk8192_hq28_hkv4_d128_bf16_causal`](helion_attention/kernels/b1_sq8192_sk8192_hq28_hkv4_d128_bf16_causal.py) | 1.4.0 | autotuned | 25.9 min | 5.808720 ms | `helion.Config(atomic_indexing=[], block_sizes=[128, 64], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor'], l2_groupings=[1], load_eviction_policies=['last', '', 'last'], loop_orders=[[1, 0]], num_sm_multiplier=32, num_stages=5, num_warps=8, pid_type='persistent_blocked', range_flattens=[True, True, True], range_multi_buffers=[True, True, False], range_num_stages=[3, 3, 0], range_unroll_factors=[2, 1, 3], range_warp_specializes=[])` |
| [`b1_sq8192_sk8192_hq32_hkv8_d128_bf16_causal`](helion_attention/kernels/b1_sq8192_sk8192_hq32_hkv8_d128_bf16_causal.py) | 1.4.0 | autotuned | 24.9 min | 5.442768 ms | `helion.Config(atomic_indexing=[], block_sizes=[128, 128], indexing=['pointer', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[32], load_eviction_policies=['last', '', 'first'], loop_orders=[[1, 0]], num_sm_multiplier=16, num_stages=3, num_warps=8, pid_type='persistent_interleaved', range_flattens=[False, False, True], range_multi_buffers=[None, None, None], range_num_stages=[3, 4, 4], range_unroll_factors=[0, 3, 3], range_warp_specializes=[])` |
...
| [`b4_sq4096_sk4096_hq28_hkv4_d128_bf16_causal`](helion_attention/kernels/b4_sq4096_sk4096_hq28_hkv4_d128_bf16_causal.py) | 1.4.0 | autotuned | 23.1 min | 1.402624 ms | `helion.Config(atomic_indexing=[], block_sizes=[128, 64], indexing=['tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[1], load_eviction_policies=['last', 'last', 'last'], loop_orders=[[1, 0]], num_sm_multiplier=1, num_stages=3, num_warps=8, pid_type='persistent_blocked', range_flattens=[False, None, None], range_multi_buffers=[None, False, False], range_num_stages=[1, 3, 0], range_unroll_factors=[2, 2, 4], range_warp_specializes=[])` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| batch=1 seqlen_q=16384 seqlen_k=16384 nheads=16 head_dim=128 dtype=bf16 causal=True | 3315 | 1715 | 3405 | 3485 | 1942 | 332 | **1.93x slower** |
| batch=1 seqlen_q=1 seqlen_k=1024 nheads=32 (GQA 32:8) head_dim=128 dtype=bf16 causal=True | 28 | 216 | 79 | 249 | 193 | 1 | **7.71x faster** |
| batch=1 seqlen_q=1 seqlen_k=16384 nheads=32 (GQA 32:8) head_dim=128 dtype=bf16 causal=True | 106 | 214 | 81 | 254 | 195 | 3 | **2.02x faster** |
| batch=1 seqlen_q=1 seqlen_k=4096 nheads=32 (GQA 32:8) head_dim=128 dtype=bf16 causal=True | 45 | 217 | 82 | 250 | 193 | 1 | **4.78x faster** |
| batch=1 seqlen_q=2048 seqlen_k=2048 nheads=28 (GQA 28:4) head_dim=128 dtype=bf16 causal=True | 411 | 352 | 213 | 209 | 195 | 73 | **1.17x slower** |
| batch=1 seqlen_q=2048 seqlen_k=2048 nheads=32 head_dim=128 dtype=bf16 causal=True | 430 | 357 | 228 | 224 | 194 | 80 | **1.20x slower** |
| batch=1 seqlen_q=2048 seqlen_k=2048 nheads=32 (GQA 32:8) head_dim=128 dtype=bf16 causal=True | 394 | 352 | 224 | 221 | 195 | 87 | **1.12x slower** |
| batch=1 seqlen_q=4096 seqlen_k=4096 nheads=28 (GQA 28:4) head_dim=128 dtype=bf16 causal=True | 1422 | 352 | 427 | 457 | 233 | 85 | **4.04x slower** |
...
| batch=1 seqlen_q=8192 seqlen_k=8192 nheads=28 (GQA 28:4) head_dim=128 dtype=bf16 causal=True | 5885 | 742 | 1498 | 1589 | 890 | 82 | **7.93x slower** |
| batch=1 seqlen_q=8192 seqlen_k=8192 nheads=32 (GQA 32:8) head_dim=128 dtype=bf16 causal=True | 5583 | 851 | 1665 | 1782 | 1049 | 98 | **6.56x slower** |
| batch=2 seqlen_q=1024 seqlen_k=1024 nheads=16 head_dim=256 dtype=bf16 causal=False | 273 | 309 | 200 | 200 | n/a | 126 | **1.13x faster** |
| batch=2 seqlen_q=1024 seqlen_k=1024 nheads=32 head_dim=64 dtype=bf16 causal=True | 128 | 350 | 198 | 197 | 196 | 67 | **2.74x faster** |
...
| batch=2 seqlen_q=8192 seqlen_k=8192 nheads=16 head_dim=128 dtype=bf16 causal=True | 5249 | 868 | 1672 | 1799 | 1056 | 105 | **6.05x slower** |
| batch=4 seqlen_q=2048 seqlen_k=2048 nheads=28 (GQA 28:4) head_dim=128 dtype=bf16 causal=True | 411 | 355 | 405 | 432 | 239 | 293 | **1.16x slower** |
...
| batch=4 seqlen_q=4096 seqlen_k=4096 nheads=28 (GQA 28:4) head_dim=128 dtype=bf16 causal=True | 1434 | 817 | 1457 | 1610 | 907 | 335 | **1.76x slower** |
| batch=4 seqlen_q=4096 seqlen_k=4096 nheads=32 head_dim=128 dtype=bf16 causal=True | 1775 | 971 | 1692 | 1826 | 1036 | 310 | **1.83x slower** |
...
| batch=4 seqlen_q=4096 seqlen_k=4096 nheads=32 head_dim=128 dtype=fp16 causal=True | 1863 | 992 | 1734 | 1863 | 1072 | 295 | **1.88x slower** |
...
| batch=4 seqlen_q=8192 seqlen_k=8192 nheads=28 (GQA 28:4) head_dim=128 dtype=bf16 causal=True | 5479 | 3107 | 5747 | 5947 | 3327 | 351 | **1.76x slower** |
| batch=4 seqlen_q=8192 seqlen_k=8192 nheads=32 (GQA 32:8) head_dim=128 dtype=bf16 causal=True | 6196 | 3579 | 6540 | 6818 | 3811 | 355 | **1.73x slower** |
...
| backward batch=8 seqlen_q=512 seqlen_k=512 nheads=16 head_dim=64 dtype=bf16 causal=False | 3741 | 633 | 554 | n/a | n/a | 6 | **5.91x slower** |
| batch=8 seqlen_q=512 seqlen_k=512 nheads=8 head_dim=32 dtype=bf16 causal=True | 31 | 355 | 196 | 194 | 194 | 35 | **11.60x faster** |
| varlen batch=8 seqlen_q=512 seqlen_k=512 nheads=16 head_dim=64 dtype=bf16 causal=True | 82 | 341 | 211 | n/a | n/a | 12 | **4.16x faster** |
...
Geomean speedup over FlashAttention 3 across all 34 comparable kernel workloads: **1.12x**.
